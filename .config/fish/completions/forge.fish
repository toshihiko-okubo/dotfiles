...
complete -c forge -n "__fish_forge_needs_command" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_needs_command" -f -a "add" -d 'Install one or multiple dependencies'
...
complete -c forge -n "__fish_forge_needs_command" -f -a "lint" -d 'Lint Solidity source files'
complete -c forge -n "__fish_forge_needs_command" -f -a "l" -d 'Lint Solidity source files'
...
complete -c forge -n "__fish_forge_needs_command" -f -a "geiger" -d 'DEPRECATED: Detects usage of unsafe cheat codes in a project and its dependencies'
...
complete -c forge -n "__fish_forge_using_subcommand test" -l block-gas-limit -l block-gas-limit -l gas-limit -d 'The block gas limit' -r
...
complete -c forge -n "__fish_forge_using_subcommand test" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
...
complete -c forge -n "__fish_forge_using_subcommand test" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand test" -l disable-labels -d 'Disables the labels in the traces'
...
complete -c forge -n "__fish_forge_using_subcommand test" -l disable-block-gas-limit -l no-block-gas-limit -l no-gas-limit -d 'Whether to disable the block gas limit checks'
complete -c forge -n "__fish_forge_using_subcommand test" -l enable-tx-gas-limit -l tx-gas-limit -d 'Whether to enable tx gas limit checks as imposed by Osaka (EIP-7825)'
...
complete -c forge -n "__fish_forge_using_subcommand test" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand test" -l rerun-failed -d 'Re-run only previously failed tests first when a change is made'
...
complete -c forge -n "__fish_forge_using_subcommand t" -l block-gas-limit -l block-gas-limit -l gas-limit -d 'The block gas limit' -r
...
complete -c forge -n "__fish_forge_using_subcommand t" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand t" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand t" -l disable-labels -d 'Disables the labels in the traces'
...
complete -c forge -n "__fish_forge_using_subcommand t" -l disable-block-gas-limit -l no-block-gas-limit -l no-gas-limit -d 'Whether to disable the block gas limit checks'
complete -c forge -n "__fish_forge_using_subcommand t" -l enable-tx-gas-limit -l tx-gas-limit -d 'Whether to enable tx gas limit checks as imposed by Osaka (EIP-7825)'
...
complete -c forge -n "__fish_forge_using_subcommand t" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand t" -l rerun-failed -d 'Re-run only previously failed tests first when a change is made'
...
complete -c forge -n "__fish_forge_using_subcommand script" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand script" -l block-gas-limit -l block-gas-limit -l gas-limit -d 'The block gas limit' -r
...
complete -c forge -n "__fish_forge_using_subcommand script" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand script" -l unlocked -d 'Send via `eth_sendTransaction` using the `--sender` argument as sender'
...
complete -c forge -n "__fish_forge_using_subcommand script" -l disable-code-size-limit -d 'Disables the contract size limit during script execution'
complete -c forge -n "__fish_forge_using_subcommand script" -l disable-labels -d 'Disables the labels in the traces'
...
complete -c forge -n "__fish_forge_using_subcommand script" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand script" -l turnkey -d 'Use Turnkey'
...
complete -c forge -n "__fish_forge_using_subcommand script" -l disable-block-gas-limit -l no-block-gas-limit -l no-gas-limit -d 'Whether to disable the block gas limit checks'
complete -c forge -n "__fish_forge_using_subcommand script" -l enable-tx-gas-limit -l tx-gas-limit -d 'Whether to enable tx gas limit checks as imposed by Osaka (EIP-7825)'
...
complete -c forge -n "__fish_forge_using_subcommand coverage" -l block-gas-limit -l block-gas-limit -l gas-limit -d 'The block gas limit' -r
...
complete -c forge -n "__fish_forge_using_subcommand coverage" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand coverage" -l exclude-tests -d 'Whether to exclude tests from the coverage report'
...
complete -c forge -n "__fish_forge_using_subcommand coverage" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand coverage" -l disable-labels -d 'Disables the labels in the traces'
...
complete -c forge -n "__fish_forge_using_subcommand coverage" -l disable-block-gas-limit -l no-block-gas-limit -l no-gas-limit -d 'Whether to disable the block gas limit checks'
complete -c forge -n "__fish_forge_using_subcommand coverage" -l enable-tx-gas-limit -l tx-gas-limit -d 'Whether to enable tx gas limit checks as imposed by Osaka (EIP-7825)'
...
complete -c forge -n "__fish_forge_using_subcommand coverage" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand coverage" -l rerun-failed -d 'Re-run only previously failed tests first when a change is made'
...
complete -c forge -n "__fish_forge_using_subcommand bind" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand bind" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand bind" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand build" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand build" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand build" -l rerun-failed -d 'Re-run only previously failed tests first when a change is made'
...
complete -c forge -n "__fish_forge_using_subcommand build" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand b" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand b" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand b" -l rerun-failed -d 'Re-run only previously failed tests first when a change is made'
...
complete -c forge -n "__fish_forge_using_subcommand b" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand compile" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand compile" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand compile" -l rerun-failed -d 'Re-run only previously failed tests first when a change is made'
...
complete -c forge -n "__fish_forge_using_subcommand compile" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand clone" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand update" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand u" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand install" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand i" -l md -d 'Format log messages as Markdown'
complete -c forge -n "__fish_forge_using_subcommand i" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c forge -n "__fish_forge_using_subcommand add" -l root -d 'The project\'s root path' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand add" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c forge -n "__fish_forge_using_subcommand add" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c forge -n "__fish_forge_using_subcommand add" -l shallow -d 'Perform shallow clones instead of deep ones'
complete -c forge -n "__fish_forge_using_subcommand add" -l no-git -d 'Install without adding the dependency as a submodule'
complete -c forge -n "__fish_forge_using_subcommand add" -l commit -d 'Create a commit after installing the dependencies'
complete -c forge -n "__fish_forge_using_subcommand add" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c forge -n "__fish_forge_using_subcommand add" -s q -l quiet -d 'Do not print log messages'
complete -c forge -n "__fish_forge_using_subcommand add" -l json -d 'Format log messages as JSON'
complete -c forge -n "__fish_forge_using_subcommand add" -l md -d 'Format log messages as Markdown'
complete -c forge -n "__fish_forge_using_subcommand add" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c forge -n "__fish_forge_using_subcommand remove" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand rm" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand remappings" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand re" -l md -d 'Format log messages as Markdown'
complete -c forge -n "__fish_forge_using_subcommand re" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c forge -n "__fish_forge_using_subcommand verify-contract" -l constructor-args -l encoded-constructor-args -d 'The ABI-encoded constructor arguments. Only for Etherscan' -r
...
complete -c forge -n "__fish_forge_using_subcommand verify-contract" -l creation-transaction-hash -d 'The hash of the transaction which created the contract. Optional for Sourcify' -r
...
complete -c forge -n "__fish_forge_using_subcommand verify-contract" -l use -d 'Specify the solc version, or a path to a local solc, to build with' -r
...
complete -c forge -n "__fish_forge_using_subcommand verify-contract" -l language -d 'The contract language (`solidity` or `vyper`)' -r -f -a "solidity\t'Solidity programming language'
...
complete -c forge -n "__fish_forge_using_subcommand verify-contract" -l no-auto-detect -d 'Do not auto-detect the `solc` version'
complete -c forge -n "__fish_forge_using_subcommand verify-contract" -s k -l insecure -d 'Allow insecure RPC connections (accept invalid HTTPS certificates)'
...
complete -c forge -n "__fish_forge_using_subcommand verify-contract" -l md -d 'Format log messages as Markdown'
complete -c forge -n "__fish_forge_using_subcommand verify-contract" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c forge -n "__fish_forge_using_subcommand v" -l constructor-args -l encoded-constructor-args -d 'The ABI-encoded constructor arguments. Only for Etherscan' -r
...
complete -c forge -n "__fish_forge_using_subcommand v" -l creation-transaction-hash -d 'The hash of the transaction which created the contract. Optional for Sourcify' -r
...
complete -c forge -n "__fish_forge_using_subcommand v" -l use -d 'Specify the solc version, or a path to a local solc, to build with' -r
...
complete -c forge -n "__fish_forge_using_subcommand v" -l language -d 'The contract language (`solidity` or `vyper`)' -r -f -a "solidity\t'Solidity programming language'
vyper\t'Vyper programming language'"
...
complete -c forge -n "__fish_forge_using_subcommand v" -l no-auto-detect -d 'Do not auto-detect the `solc` version'
complete -c forge -n "__fish_forge_using_subcommand v" -s k -l insecure -d 'Allow insecure RPC connections (accept invalid HTTPS certificates)'
...
complete -c forge -n "__fish_forge_using_subcommand v" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand verify-check" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand vc" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand verify-bytecode" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand vb" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand create" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand create" -l browser-port -d 'Port for the browser wallet server' -r
...
complete -c forge -n "__fish_forge_using_subcommand create" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand create" -s k -l insecure -d 'Allow insecure RPC connections (accept invalid HTTPS certificates)'
...
complete -c forge -n "__fish_forge_using_subcommand create" -l turnkey -d 'Use Turnkey'
complete -c forge -n "__fish_forge_using_subcommand create" -l browser -d 'Use a browser wallet'
complete -c forge -n "__fish_forge_using_subcommand create" -l browser-disable-open -d 'Whether to open the browser for wallet connection'
complete -c forge -n "__fish_forge_using_subcommand create" -l browser-development -d 'Enable development mode for the browser wallet. This relaxes certain security features for local development'
...
complete -c forge -n "__fish_forge_using_subcommand create" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand c" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand c" -l browser-port -d 'Port for the browser wallet server' -r
...
complete -c forge -n "__fish_forge_using_subcommand c" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand c" -s k -l insecure -d 'Allow insecure RPC connections (accept invalid HTTPS certificates)'
...
complete -c forge -n "__fish_forge_using_subcommand c" -l turnkey -d 'Use Turnkey'
complete -c forge -n "__fish_forge_using_subcommand c" -l browser -d 'Use a browser wallet'
complete -c forge -n "__fish_forge_using_subcommand c" -l browser-disable-open -d 'Whether to open the browser for wallet connection'
complete -c forge -n "__fish_forge_using_subcommand c" -l browser-development -d 'Enable development mode for the browser wallet. This relaxes certain security features for local development'
...
complete -c forge -n "__fish_forge_using_subcommand c" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand init" -l vyper -d 'Initialize a Vyper project template'
complete -c forge -n "__fish_forge_using_subcommand init" -l use-parent-git -d 'Use the parent git repository instead of initializing a new one. Only valid if the target is in a git repository'
complete -c forge -n "__fish_forge_using_subcommand init" -l empty -d 'Do not create example contracts (Counter.sol, Counter.t.sol, Counter.s.sol)'
...
complete -c forge -n "__fish_forge_using_subcommand init" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand completions" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand com" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand clean" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand cl" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand cache; and not __fish_seen_subcommand_from clean ls help" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand cache; and __fish_seen_subcommand_from clean" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand cache; and __fish_seen_subcommand_from ls" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand snapshot" -l diff-sort -d 'How to sort diff results' -r -f -a "percentage\t'Sort by percentage change (smallest to largest) - default behavior'
...
complete -c forge -n "__fish_forge_using_subcommand snapshot" -l block-gas-limit -l block-gas-limit -l gas-limit -d 'The block gas limit' -r
...
complete -c forge -n "__fish_forge_using_subcommand snapshot" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand snapshot" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand snapshot" -l disable-labels -d 'Disables the labels in the traces'
...
complete -c forge -n "__fish_forge_using_subcommand snapshot" -l disable-block-gas-limit -l no-block-gas-limit -l no-gas-limit -d 'Whether to disable the block gas limit checks'
complete -c forge -n "__fish_forge_using_subcommand snapshot" -l enable-tx-gas-limit -l tx-gas-limit -d 'Whether to enable tx gas limit checks as imposed by Osaka (EIP-7825)'
...
complete -c forge -n "__fish_forge_using_subcommand snapshot" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand snapshot" -l rerun-failed -d 'Re-run only previously failed tests first when a change is made'
...
complete -c forge -n "__fish_forge_using_subcommand s" -l diff-sort -d 'How to sort diff results' -r -f -a "percentage\t'Sort by percentage change (smallest to largest) - default behavior'
percentage-desc\t'Sort by percentage change (largest to smallest)'
absolute\t'Sort by absolute gas change (smallest to largest)'
absolute-desc\t'Sort by absolute gas change (largest to smallest)'"
...
complete -c forge -n "__fish_forge_using_subcommand s" -l block-gas-limit -l block-gas-limit -l gas-limit -d 'The block gas limit' -r
...
complete -c forge -n "__fish_forge_using_subcommand s" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand s" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand s" -l disable-labels -d 'Disables the labels in the traces'
...
complete -c forge -n "__fish_forge_using_subcommand s" -l disable-block-gas-limit -l no-block-gas-limit -l no-gas-limit -d 'Whether to disable the block gas limit checks'
complete -c forge -n "__fish_forge_using_subcommand s" -l enable-tx-gas-limit -l tx-gas-limit -d 'Whether to enable tx gas limit checks as imposed by Osaka (EIP-7825)'
...
complete -c forge -n "__fish_forge_using_subcommand s" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand s" -l rerun-failed -d 'Re-run only previously failed tests first when a change is made'
...
complete -c forge -n "__fish_forge_using_subcommand config" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand config" -l block-gas-limit -l block-gas-limit -l gas-limit -d 'The block gas limit' -r
...
complete -c forge -n "__fish_forge_using_subcommand config" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand config" -l rerun-failed -d 'Re-run only previously failed tests first when a change is made'
...
complete -c forge -n "__fish_forge_using_subcommand config" -l disable-block-gas-limit -l no-block-gas-limit -l no-gas-limit -d 'Whether to disable the block gas limit checks'
complete -c forge -n "__fish_forge_using_subcommand config" -l enable-tx-gas-limit -l tx-gas-limit -d 'Whether to enable tx gas limit checks as imposed by Osaka (EIP-7825)'
...
complete -c forge -n "__fish_forge_using_subcommand config" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand co" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand co" -l block-gas-limit -l block-gas-limit -l gas-limit -d 'The block gas limit' -r
...
complete -c forge -n "__fish_forge_using_subcommand co" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand co" -l rerun-failed -d 'Re-run only previously failed tests first when a change is made'
...
complete -c forge -n "__fish_forge_using_subcommand co" -l disable-block-gas-limit -l no-block-gas-limit -l no-gas-limit -d 'Whether to disable the block gas limit checks'
complete -c forge -n "__fish_forge_using_subcommand co" -l enable-tx-gas-limit -l tx-gas-limit -d 'Whether to enable tx gas limit checks as imposed by Osaka (EIP-7825)'
...
complete -c forge -n "__fish_forge_using_subcommand co" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand flatten" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand f" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand fmt" -l rerun-failed -d 'Re-run only previously failed tests first when a change is made'
...
complete -c forge -n "__fish_forge_using_subcommand fmt" -l md -d 'Format log messages as Markdown'
complete -c forge -n "__fish_forge_using_subcommand fmt" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c forge -n "__fish_forge_using_subcommand lint" -l severity -d 'Specifies which lints to run based on severity. Overrides the `severity` project config' -r -f -a "high\t''
med\t''
low\t''
info\t''
gas\t''
code-size\t''"
complete -c forge -n "__fish_forge_using_subcommand lint" -l only-lint -d 'Specifies which lints to run based on their ID (e.g., "incorrect-shift"). Overrides the `exclude_lints` project config' -r
complete -c forge -n "__fish_forge_using_subcommand lint" -l libraries -d 'Set pre-linked libraries' -r
complete -c forge -n "__fish_forge_using_subcommand lint" -l ignored-error-codes -d 'Ignore solc warnings by error code' -r
complete -c forge -n "__fish_forge_using_subcommand lint" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
complete -c forge -n "__fish_forge_using_subcommand lint" -l use -d 'Specify the solc version, or a path to a local solc, to build with' -r
complete -c forge -n "__fish_forge_using_subcommand lint" -s o -l out -d 'The path to the contract artifacts folder' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand lint" -l revert-strings -d 'Revert string configuration' -r
complete -c forge -n "__fish_forge_using_subcommand lint" -l build-info-path -d 'Output path to directory that build info files will be written to' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand lint" -l skip -d 'Skip building files whose names contain the given filter' -r
complete -c forge -n "__fish_forge_using_subcommand lint" -l evm-version -d 'The target EVM version' -r
complete -c forge -n "__fish_forge_using_subcommand lint" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "true\t''
false\t''"
complete -c forge -n "__fish_forge_using_subcommand lint" -l optimizer-runs -d 'The number of runs specifies roughly how often each opcode of the deployed code will be executed across the life-time of the contract. This means it is a trade-off parameter between code size (deploy cost) and code execution cost (cost after deployment). An `optimizer_runs` parameter of `1` will produce short but expensive code. In contrast, a larger `optimizer_runs` parameter will produce longer but more gas efficient code' -r
complete -c forge -n "__fish_forge_using_subcommand lint" -l extra-output -d 'Extra output to include in the contract\'s artifact' -r
complete -c forge -n "__fish_forge_using_subcommand lint" -l extra-output-files -d 'Extra output to write to separate files' -r
complete -c forge -n "__fish_forge_using_subcommand lint" -l root -d 'The project\'s root path' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand lint" -s C -l contracts -d 'The contracts source directory' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand lint" -s R -l remappings -d 'The project\'s remappings' -r
complete -c forge -n "__fish_forge_using_subcommand lint" -l remappings-env -d 'The project\'s remappings from the environment' -r
complete -c forge -n "__fish_forge_using_subcommand lint" -l cache-path -d 'The path to the compiler cache' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand lint" -l lib-paths -d 'The path to the library folder' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand lint" -l config-path -d 'Path to the config file' -r -F
complete -c forge -n "__fish_forge_using_subcommand lint" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c forge -n "__fish_forge_using_subcommand lint" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c forge -n "__fish_forge_using_subcommand lint" -l force -d 'Clear the cache and artifacts folder and recompile'
complete -c forge -n "__fish_forge_using_subcommand lint" -l no-cache -d 'Disable the cache'
complete -c forge -n "__fish_forge_using_subcommand lint" -l dynamic-test-linking -d 'Enable dynamic test linking'
complete -c forge -n "__fish_forge_using_subcommand lint" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
complete -c forge -n "__fish_forge_using_subcommand lint" -l no-auto-detect -d 'Do not auto-detect the `solc` version'
complete -c forge -n "__fish_forge_using_subcommand lint" -l offline -d 'Do not access the network'
complete -c forge -n "__fish_forge_using_subcommand lint" -l via-ir -d 'Use the Yul intermediate representation compilation pipeline'
complete -c forge -n "__fish_forge_using_subcommand lint" -l use-literal-content -d 'Changes compilation to only use literal content and not URLs'
complete -c forge -n "__fish_forge_using_subcommand lint" -l no-metadata -d 'Do not append any metadata to the bytecode'
complete -c forge -n "__fish_forge_using_subcommand lint" -l build-info -d 'Generate build info files'
complete -c forge -n "__fish_forge_using_subcommand lint" -l ast -d 'Includes the AST as JSON in the compiler output'
complete -c forge -n "__fish_forge_using_subcommand lint" -l hardhat -l hh -d 'Use the Hardhat-style project layout'
complete -c forge -n "__fish_forge_using_subcommand lint" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c forge -n "__fish_forge_using_subcommand lint" -s q -l quiet -d 'Do not print log messages'
complete -c forge -n "__fish_forge_using_subcommand lint" -l json -d 'Format log messages as JSON'
complete -c forge -n "__fish_forge_using_subcommand lint" -l md -d 'Format log messages as Markdown'
complete -c forge -n "__fish_forge_using_subcommand lint" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c forge -n "__fish_forge_using_subcommand l" -l severity -d 'Specifies which lints to run based on severity. Overrides the `severity` project config' -r -f -a "high\t''
med\t''
low\t''
info\t''
gas\t''
code-size\t''"
complete -c forge -n "__fish_forge_using_subcommand l" -l only-lint -d 'Specifies which lints to run based on their ID (e.g., "incorrect-shift"). Overrides the `exclude_lints` project config' -r
complete -c forge -n "__fish_forge_using_subcommand l" -l libraries -d 'Set pre-linked libraries' -r
complete -c forge -n "__fish_forge_using_subcommand l" -l ignored-error-codes -d 'Ignore solc warnings by error code' -r
complete -c forge -n "__fish_forge_using_subcommand l" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
complete -c forge -n "__fish_forge_using_subcommand l" -l use -d 'Specify the solc version, or a path to a local solc, to build with' -r
complete -c forge -n "__fish_forge_using_subcommand l" -s o -l out -d 'The path to the contract artifacts folder' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand l" -l revert-strings -d 'Revert string configuration' -r
complete -c forge -n "__fish_forge_using_subcommand l" -l build-info-path -d 'Output path to directory that build info files will be written to' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand l" -l skip -d 'Skip building files whose names contain the given filter' -r
complete -c forge -n "__fish_forge_using_subcommand l" -l evm-version -d 'The target EVM version' -r
complete -c forge -n "__fish_forge_using_subcommand l" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "true\t''
false\t''"
complete -c forge -n "__fish_forge_using_subcommand l" -l optimizer-runs -d 'The number of runs specifies roughly how often each opcode of the deployed code will be executed across the life-time of the contract. This means it is a trade-off parameter between code size (deploy cost) and code execution cost (cost after deployment). An `optimizer_runs` parameter of `1` will produce short but expensive code. In contrast, a larger `optimizer_runs` parameter will produce longer but more gas efficient code' -r
complete -c forge -n "__fish_forge_using_subcommand l" -l extra-output -d 'Extra output to include in the contract\'s artifact' -r
complete -c forge -n "__fish_forge_using_subcommand l" -l extra-output-files -d 'Extra output to write to separate files' -r
complete -c forge -n "__fish_forge_using_subcommand l" -l root -d 'The project\'s root path' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand l" -s C -l contracts -d 'The contracts source directory' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand l" -s R -l remappings -d 'The project\'s remappings' -r
complete -c forge -n "__fish_forge_using_subcommand l" -l remappings-env -d 'The project\'s remappings from the environment' -r
complete -c forge -n "__fish_forge_using_subcommand l" -l cache-path -d 'The path to the compiler cache' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand l" -l lib-paths -d 'The path to the library folder' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand l" -l config-path -d 'Path to the config file' -r -F
complete -c forge -n "__fish_forge_using_subcommand l" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c forge -n "__fish_forge_using_subcommand l" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c forge -n "__fish_forge_using_subcommand l" -l force -d 'Clear the cache and artifacts folder and recompile'
complete -c forge -n "__fish_forge_using_subcommand l" -l no-cache -d 'Disable the cache'
complete -c forge -n "__fish_forge_using_subcommand l" -l dynamic-test-linking -d 'Enable dynamic test linking'
complete -c forge -n "__fish_forge_using_subcommand l" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
complete -c forge -n "__fish_forge_using_subcommand l" -l no-auto-detect -d 'Do not auto-detect the `solc` version'
complete -c forge -n "__fish_forge_using_subcommand l" -l offline -d 'Do not access the network'
complete -c forge -n "__fish_forge_using_subcommand l" -l via-ir -d 'Use the Yul intermediate representation compilation pipeline'
complete -c forge -n "__fish_forge_using_subcommand l" -l use-literal-content -d 'Changes compilation to only use literal content and not URLs'
complete -c forge -n "__fish_forge_using_subcommand l" -l no-metadata -d 'Do not append any metadata to the bytecode'
complete -c forge -n "__fish_forge_using_subcommand l" -l build-info -d 'Generate build info files'
complete -c forge -n "__fish_forge_using_subcommand l" -l ast -d 'Includes the AST as JSON in the compiler output'
complete -c forge -n "__fish_forge_using_subcommand l" -l hardhat -l hh -d 'Use the Hardhat-style project layout'
complete -c forge -n "__fish_forge_using_subcommand l" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c forge -n "__fish_forge_using_subcommand l" -s q -l quiet -d 'Do not print log messages'
complete -c forge -n "__fish_forge_using_subcommand l" -l json -d 'Format log messages as JSON'
complete -c forge -n "__fish_forge_using_subcommand l" -l md -d 'Format log messages as Markdown'
complete -c forge -n "__fish_forge_using_subcommand l" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c forge -n "__fish_forge_using_subcommand inspect" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand inspect" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand inspect" -s w -l wrap -d 'Whether to wrap the table to the terminal width'
...
complete -c forge -n "__fish_forge_using_subcommand inspect" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand in" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand in" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand in" -s w -l wrap -d 'Whether to wrap the table to the terminal width'
...
complete -c forge -n "__fish_forge_using_subcommand in" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand tree" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand tr" -l md -d 'Format log messages as Markdown'
complete -c forge -n "__fish_forge_using_subcommand tr" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c forge -n "__fish_forge_using_subcommand geiger" -l libraries -d 'Set pre-linked libraries' -r
complete -c forge -n "__fish_forge_using_subcommand geiger" -l ignored-error-codes -d 'Ignore solc warnings by error code' -r
complete -c forge -n "__fish_forge_using_subcommand geiger" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
complete -c forge -n "__fish_forge_using_subcommand geiger" -l use -d 'Specify the solc version, or a path to a local solc, to build with' -r
complete -c forge -n "__fish_forge_using_subcommand geiger" -s o -l out -d 'The path to the contract artifacts folder' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand geiger" -l revert-strings -d 'Revert string configuration' -r
complete -c forge -n "__fish_forge_using_subcommand geiger" -l build-info-path -d 'Output path to directory that build info files will be written to' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand geiger" -l skip -d 'Skip building files whose names contain the given filter' -r
complete -c forge -n "__fish_forge_using_subcommand geiger" -l evm-version -d 'The target EVM version' -r
complete -c forge -n "__fish_forge_using_subcommand geiger" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "true\t''
false\t''"
complete -c forge -n "__fish_forge_using_subcommand geiger" -l optimizer-runs -d 'The number of runs specifies roughly how often each opcode of the deployed code will be executed across the life-time of the contract. This means it is a trade-off parameter between code size (deploy cost) and code execution cost (cost after deployment). An `optimizer_runs` parameter of `1` will produce short but expensive code. In contrast, a larger `optimizer_runs` parameter will produce longer but more gas efficient code' -r
complete -c forge -n "__fish_forge_using_subcommand geiger" -l extra-output -d 'Extra output to include in the contract\'s artifact' -r
complete -c forge -n "__fish_forge_using_subcommand geiger" -l extra-output-files -d 'Extra output to write to separate files' -r
...
complete -c forge -n "__fish_forge_using_subcommand geiger" -s C -l contracts -d 'The contracts source directory' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand geiger" -s R -l remappings -d 'The project\'s remappings' -r
complete -c forge -n "__fish_forge_using_subcommand geiger" -l remappings-env -d 'The project\'s remappings from the environment' -r
complete -c forge -n "__fish_forge_using_subcommand geiger" -l cache-path -d 'The path to the compiler cache' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand geiger" -l lib-paths -d 'The path to the library folder' -r -f -a "(__fish_complete_directories)"
complete -c forge -n "__fish_forge_using_subcommand geiger" -l config-path -d 'Path to the config file' -r -F
...
complete -c forge -n "__fish_forge_using_subcommand geiger" -l force -d 'Clear the cache and artifacts folder and recompile'
complete -c forge -n "__fish_forge_using_subcommand geiger" -l no-cache -d 'Disable the cache'
complete -c forge -n "__fish_forge_using_subcommand geiger" -l dynamic-test-linking -d 'Enable dynamic test linking'
complete -c forge -n "__fish_forge_using_subcommand geiger" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
complete -c forge -n "__fish_forge_using_subcommand geiger" -l no-auto-detect -d 'Do not auto-detect the `solc` version'
complete -c forge -n "__fish_forge_using_subcommand geiger" -l offline -d 'Do not access the network'
complete -c forge -n "__fish_forge_using_subcommand geiger" -l via-ir -d 'Use the Yul intermediate representation compilation pipeline'
complete -c forge -n "__fish_forge_using_subcommand geiger" -l use-literal-content -d 'Changes compilation to only use literal content and not URLs'
complete -c forge -n "__fish_forge_using_subcommand geiger" -l no-metadata -d 'Do not append any metadata to the bytecode'
complete -c forge -n "__fish_forge_using_subcommand geiger" -l build-info -d 'Generate build info files'
complete -c forge -n "__fish_forge_using_subcommand geiger" -l ast -d 'Includes the AST as JSON in the compiler output'
complete -c forge -n "__fish_forge_using_subcommand geiger" -l hardhat -l hh -d 'Use the Hardhat-style project layout'
...
complete -c forge -n "__fish_forge_using_subcommand geiger" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand doc" -l rerun-failed -d 'Re-run only previously failed tests first when a change is made'
...
complete -c forge -n "__fish_forge_using_subcommand doc" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and not __fish_seen_subcommand_from collision co upload up list ls find f cache c help" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from collision" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from collision" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from collision" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from co" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from co" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from co" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from upload" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from up" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from list" -l no-group -d 'Do not group the selectors by contract in separate tables.'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from list" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from ls" -l no-group -d 'Do not group the selectors by contract in separate tables.'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from ls" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from find" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from f" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from cache" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from c" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand se; and not __fish_seen_subcommand_from collision co upload up list ls find f cache c help" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from collision" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from collision" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from collision" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from co" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from co" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from co" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from upload" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from up" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from list" -l no-group -d 'Do not group the selectors by contract in separate tables.'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from list" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from ls" -l no-group -d 'Do not group the selectors by contract in separate tables.'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from ls" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from find" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from f" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from cache" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from c" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand generate; and not __fish_seen_subcommand_from test help" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand generate; and __fish_seen_subcommand_from test" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand compiler; and not __fish_seen_subcommand_from resolve r help" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand compiler; and __fish_seen_subcommand_from resolve" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand compiler; and __fish_seen_subcommand_from r" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -s q -l quiet -d 'Do not print log messages'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -l json -d 'Format log messages as JSON'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -l md -d 'Format log messages as Markdown'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -f -a "init" -d 'Convert a Foundry project to use Soldeer'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -f -a "install" -d 'Install a dependency'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -f -a "update" -d 'Update dependencies by reading the config file'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -f -a "login" -d 'Log into the central repository to push packages'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -f -a "push" -d 'Push a dependency to the repository'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -f -a "uninstall" -d 'Uninstall a dependency'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -f -a "clean" -d 'Clean downloaded dependencies and generated artifacts'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -f -a "version" -d 'Display the version of Soldeer'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall clean version help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from init" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from install" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from update" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from login" -l token -d 'Login with a token created via soldeer.xyz' -r
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from login" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from push" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from uninstall" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from clean" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from clean" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from clean" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from clean" -s q -l quiet -d 'Do not print log messages'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from clean" -l json -d 'Format log messages as JSON'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from clean" -l md -d 'Format log messages as Markdown'
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from clean" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from version" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from help" -f -a "clean" -d 'Clean downloaded dependencies and generated artifacts'
...
complete -c forge -n "__fish_forge_using_subcommand eip712" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand eip712" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand eip712" -l md -d 'Format log messages as Markdown'
...
complete -c forge -n "__fish_forge_using_subcommand bind-json" -s D -l deny -d 'A compiler error will be triggered at the specified diagnostic level' -r -f -a "never\t'Always exit with zero code'
warnings\t'Exit with a non-zero code if any warnings are found'
notes\t'Exit with a non-zero code if any notes or warnings are found'"
...
complete -c forge -n "__fish_forge_using_subcommand bind-json" -l deny-warnings -d 'Deprecated: use `--deny=warnings` instead'
...
complete -c forge -n "__fish_forge_using_subcommand help; and not __fish_seen_subcommand_from test script coverage bind build clone update install remove remappings verify-contract verify-check verify-bytecode create init completions clean cache snapshot config flatten fmt lint inspect tree geiger doc selectors generate compiler soldeer eip712 bind-json help" -f -a "geiger" -d 'DEPRECATED: Detects usage of unsafe cheat codes in a project and its dependencies'
...
complete -c forge -n "__fish_forge_using_subcommand help; and __fish_seen_subcommand_from soldeer" -f -a "clean" -d 'Clean downloaded dependencies and generated artifacts'
