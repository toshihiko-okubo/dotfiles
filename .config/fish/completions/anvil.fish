...
complete -c anvil -n "__fish_anvil_needs_command" -l number -d 'The number of the genesis block' -r
...
complete -c anvil -n "__fish_anvil_needs_command" -l fork-transaction-hash -d 'Fetch state from after a specific transaction hash has been applied over a remote endpoint' -r
...
complete -c anvil -n "__fish_anvil_needs_command" -l md -d 'Format log messages as Markdown'
...
complete -c anvil -n "__fish_anvil_needs_command" -l print-traces -l enable-trace-printing -d 'Enable printing of traces for executed transactions and `eth_call` to stdout'
...
complete -c anvil -n "__fish_anvil_needs_command" -l disable-pool-balance-checks -d 'Disable pool balance checks'
complete -c anvil -n "__fish_anvil_needs_command" -l optimism -l optimism -d 'Enable Optimism network features'
complete -c anvil -n "__fish_anvil_needs_command" -l celo -d 'Enable Celo network features'
...
complete -c anvil -n "__fish_anvil_using_subcommand completions" -l md -d 'Format log messages as Markdown'
...
complete -c anvil -n "__fish_anvil_using_subcommand com" -l md -d 'Format log messages as Markdown'
complete -c anvil -n "__fish_anvil_using_subcommand com" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c anvil -n "__fish_anvil_using_subcommand help; and not __fish_seen_subcommand_from completions help" -f -a "completions" -d 'Generate shell completions script'
complete -c anvil -n "__fish_anvil_using_subcommand help; and not __fish_seen_subcommand_from completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
