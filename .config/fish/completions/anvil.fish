...
complete -c anvil -n "__fish_use_subcommand" -l fork-transaction-hash -d 'Fetch state from a specific transaction hash over a remote endpoint' -r
...
complete -c anvil -n "__fish_use_subcommand" -l allow-origin -d 'The cors `allow_origin` header' -r
...
complete -c anvil -n "__fish_use_subcommand" -l disable-console-log -l no-console-log -d 'Disable printing of `console.log` invocations to stdout'
...
complete -c anvil -n "__fish_use_subcommand" -l no-request-size-limit -d 'Disable the default request body size limit. At time of writing the default limit is 2MB'
...
complete -c anvil -n "__fish_use_subcommand" -f -a "com" -d 'Generate shell completions script'
complete -c anvil -n "__fish_use_subcommand" -f -a "generate-fig-spec" -d 'Generate Fig autocompletion spec'
complete -c anvil -n "__fish_use_subcommand" -f -a "fig" -d 'Generate Fig autocompletion spec'
...
complete -c anvil -n "__fish_seen_subcommand_from com" -s h -l help -d 'Print help'
complete -c anvil -n "__fish_seen_subcommand_from generate-fig-spec" -s h -l help -d 'Print help'
complete -c anvil -n "__fish_seen_subcommand_from fig" -s h -l help -d 'Print help'
complete -c anvil -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from completions generate-fig-spec help" -f -a "completions" -d 'Generate shell completions script'
complete -c anvil -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from completions generate-fig-spec help" -f -a "generate-fig-spec" -d 'Generate Fig autocompletion spec'
complete -c anvil -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from completions generate-fig-spec help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
